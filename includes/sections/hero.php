          ...
          <div class="container position-relative">
            <div class="row gy-4 mt-5">
              <div class="col-xl-3 col-md-6">
                <div class="icon-box">
                  <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-house-heart-fill" viewBox="0 0 16 16">
              ...
              <div class="col-xl-3 col-md-6">
                <div class="icon-box">
                  <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-emoji-wink-fill" viewBox="0 0 16 16">
                  ...
                  <h4 class="title">
                    <a href="" class="stretched-link">NYAMAN</a>
                  </h4>
                </div>
              </div>
              <!--End Icon Box -->
              ...
              <div class="col-xl-3 col-md-6">
                <div class="icon-box">
                  ...
                  <h4 class="title">
                    <a href="" class="stretched-link">STRATEGIS</a>
                  </h4>
                </div>
              </div>
              <!--End Icon Box -->
